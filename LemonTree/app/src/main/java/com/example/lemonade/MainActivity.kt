...
class MainActivity : AppCompatActivity() {
    ...
    private fun setViewElements() {
        ...
        //Finding the ID of Text to be displayed
        ...
        //Finding the ID of Image to be displayed
        ...
        findViewById<ImageView>(R.id.image_lemon_state).setImageResource(lemonImage)
    }
